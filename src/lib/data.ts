...
export const events: Event[] = [
  {
    ...
    description: {
      fr: "L'Association du Salon du Livre de l'Enfant de Sfax invite ses membres et partenaires à son Assemblée Générale Annuelle au siège de l'association (Route Lafrane km 2).",
      en: "The Sfax Children's Book Fair Association invites its members and partners to its Annual General Assembly at the association's headquarters (Route Lafrane km 2).",
      ar: "تتشرف جمعية معرض صفاقس لكتاب الطفل بدعوتكم لحضور الجلسة العامة السنوية بمقر الجمعية (طريق لفران كم 2).",
    },
    content: {
      fr: "L'Association du Salon du Livre de l'Enfant de Sfax est honorée d'inviter ses membres, partenaires et amis à participer à son Assemblée Générale Annuelle. Cet événement se tiendra le samedi 9 mai 2026 à partir de 15h00 au siège de l'association. Votre présence est essentielle pour soutenir nos initiatives culturelles en faveur de la jeunesse et discuter des perspectives futures du Salon.",
      en: "The Sfax Children's Book Fair Association is proud to invite its members, partners, and supporters to its Annual General Assembly. The meeting will take place on Saturday, May 9, 2026, at 3:00 PM at the association's headquarters. Your participation is vital as we discuss our future cultural initiatives for children and the upcoming editions of the Fair.",
      ar: "تتشرف جمعية معرض صفاقس لكتاب الطفل بدعوة كافة أعضائها ومنخرطيها وأصدقاء الجمعية لحضور الجلسة العامة السنوية، وذلك يوم السبت 9 ماي 2026، على الساعة الثالثة بعد الزوال بمقر الجمعية. حضوركم دعم لمسيرة الجمعية ويسعدنا تواجدكم معنا لمناقشة آفاق العمل الثقافي الموجه للطفل وتطوير فعاليات المعرض.",
    },
    date: "2026-05-09",
    location: {
      fr: "Siège de l'Association, Route Lafrane km 2, Sfax, Tunisie, 3013",
      en: "Association Headquarters, Route Lafrane km 2, Sfax, Tunisia, 3013",
...
export const members: Member[] = [
  { name: "Slim Achiche", role: { fr: "Président", en: "President", ar: "رئيس" }, bio: { fr: "Président de l'association, engagé dans la promotion de la lecture et de la culture pour les enfants de Sfax.", en: "President of the association, committed to promoting reading and culture for the children of Sfax.", ar: "رئيس الجمعية، ملتزم بتعزيز القراءة والثقافة لأطفال صفاقس." }, image: slimAchicheImage, category: "board" },
  { name: "Hamadi Guermazi", role: { fr: "Vice-président", en: "Vice President", ar: "نائب الرئيس" }, bio: { fr: "Vice-président de l'association, contribuant activement au développement des activités culturelles.", en: "Vice president of the association, actively contributing to the development of cultural activities.", ar: "نائب رئيس الجمعية، يساهم بنشاط في تطوير الأنشطة الثقافية." }, image: "/placeholder.svg", category: "board" },
  { name: "Foued Sahnoun", role: { fr: "Secrétaire général", en: "Secretary General", ar: "كاتب عام" }, bio: { fr: "Secrétaire général de l'association, assurant la coordination et le suivi des activités.", en: "Secretary general of the association, ensuring coordination and follow-up of activities.", ar: "الكاتب العام للجمعية، يضمن التنسيق ومتابعة الأنشطة." }, image: "/placeholder.svg", category: "board" },
  { name: "Sarra Charfi", role: { fr: "Secrétaire générale adjointe", en: "Deputy Secretary General", ar: "كاتب عام مساعد" }, bio: { fr: "Secrétaire générale adjointe, soutenant la gestion administrative de l'association.", en: "Deputy secretary general, supporting the administrative management of the association.", ar: "الكاتب العام المساعد، تدعم الإدارة الإدارية للجمعية." }, image: sarraCharfiImage, category: "board" },
  { name: "Mohsen Bouchaala", role: { fr: "Trésorier", en: "Treasurer", ar: "أمين مال" }, bio: { fr: "Trésorier de l'association, veillant à la gestion financière transparente et rigoureuse.", en: "Treasurer of the association, ensuring transparent and rigorous financial management.", ar: "أمين مال الجمعية، يحرص على الإدارة المالية الشفافة والصارمة." }, image: mohsenBouchalaImage, category: "board" },
  { name: "Chafik Ghorbel", role: { fr: "Chargé de communication", en: "Communications Officer", ar: "مسؤول التواصل" }, bio: { fr: "Responsable de la communication et de la visibilité de l'association.", en: "Responsible for the association's communication and visibility.", ar: "مسؤول عن التواصل وإبراز صورة الجمعية." }, image: chafikGhorbelImage, category: "committee" },
  { name: "Chefya Hdider", role: { fr: "Chargée de l'activité culturelle", en: "Cultural Activities Officer", ar: "مسؤول الأنشطة الثقافية" }, bio: { fr: "En charge de la programmation et de l'animation des activités culturelles.", en: "In charge of programming and facilitating cultural activities.", ar: "مسؤولة عن برمجة وتنشيط الفعاليات الثقافية." }, image: chefyaHdiderImage, category: "committee" },
  { name: "Wajdi Atitallah", role: { fr: "Représentant juridique légal", en: "Legal Representative", ar: "الممثل القانوني" }, bio: { fr: "Représentant juridique de l'association, assurant le cadre légal de ses activités.", en: "Legal representative of the association, ensuring the legal framework of its activities.", ar: "الممثل القانوني للجمعية، يضمن الإطار القانوني لأنشطتها." }, image: wajdiAtitallahImage, category: "committee" },
  { name: "Sawssan Amri", role: { fr: "Membre", en: "Member", ar: "عضو" }, bio: { fr: "Membre active du comité, contribuant aux différentes initiatives de l'association.", en: "Active committee member, contributing to the association's various initiatives.", ar: "عضو نشط في اللجنة، تساهم في مختلف مبادرات الجمعية." }, image: "/placeholder.svg", category: "committee" },
];
